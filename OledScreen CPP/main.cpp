...
int main(int main_argc, char *main_argv[])
{
	...
	for(unsigned int n = 0; n < gDisplays.size(); ++n)
	{
		...
		u8g2.setFontRefHeightText();
		u8g2.setFontPosTop();
		u8g2.drawStr(0, 0, "Micotune v1.0");
		u8g2.drawStr(0, 7, "Nature controlled soundscapes");
		u8g2.drawStr(0, 14, "  __  ____           __                 ");
		u8g2.drawStr(0, 21, " /  |/  (_)________ / /___  ______  ___ ");
		u8g2.drawStr(0, 28, "/ /|_/ / / ___/ __ / __/ / / / __ \/ _ \ ");
		u8g2.drawStr(0, 35, " /  / / / /__/ /_// /_/ /_/ / / / /  __/");
		u8g2.drawStr(0, 42, "/  /_/_/____/____/___/_____/_/ /_/____/");
		u8g2.drawStr(0, 49, " ");
		u8g2.drawStr(0, 56, "");
		u8g2.drawStr(0, 64, "");
		if(gDisplays.size() > 1)
