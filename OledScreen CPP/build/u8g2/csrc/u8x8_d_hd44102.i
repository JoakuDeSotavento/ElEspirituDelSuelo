# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_hd44102.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_hd44102.c" 2
# 38 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_hd44102.c"
...
# 39 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_hd44102.c" 2
...
# 76 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_hd44102.c"
static void u8x8_hd44102_outy(u8x8_t *u8x8, uint8_t *data, uint8_t cnt, uint8_t page, uint8_t offset, uint8_t cs_none, uint8_t cs0, uint8_t cs1, uint8_t cs2)
{
  ...
  if ( pos < 100 && cnt > 0 )
  {
    ...
    u8x8->cad_cb(u8x8, 24, cs1, ((void*)0));
  ...
  if ( pos < 150 && cnt > 0 )
  {
    ...
    u8x8->cad_cb(u8x8, 24, cs2, ((void*)0));
...
uint8_t u8x8_d_t7932_150x32(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
    ...
    case 10:
      ...
      for( i = 0; i < 3; i++ )
      {
        u8x8->cad_cb(u8x8, 24, cs[i], ((void*)0));
        u8x8_cad_SendSequence(u8x8, u8x8_d_hd44102_init_seq);
        u8x8->cad_cb(u8x8, 25, cs[3], ((void*)0));
      }
...
uint8_t u8x8_d_hd44102_100x64(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
    ...
    case 10:
      ...
      for( i = 0; i < 4; i++ )
      {
        u8x8->cad_cb(u8x8, 24, i, ((void*)0));
        u8x8_cad_SendSequence(u8x8, u8x8_d_hd44102_init_seq);
        u8x8->cad_cb(u8x8, 25, 7, ((void*)0));
      }
