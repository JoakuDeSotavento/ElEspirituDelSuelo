# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/mui_u8g2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/mui_u8g2.c" 2
# 146 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/mui_u8g2.c"
...
# 147 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/mui_u8g2.c" 2
...
# 148 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/mui_u8g2.c" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/mui_u8g2.h" 1
# 53 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/mui_u8g2.h"
...
# 79 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/mui_u8g2.h"
...
# 99 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/mui_u8g2.h"
...
# 127 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/mui_u8g2.h"
...
# 199 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/mui_u8g2.h"
uint8_t mui_u8g2_set_font_style_function(mui_t *ui, uint8_t msg);
# 210 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/mui_u8g2.h"
...
# 228 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/mui_u8g2.h"
...
# 242 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/mui_u8g2.h"
...
# 149 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/mui_u8g2.c" 2
# 191 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/mui_u8g2.c"
static void u8g2_DrawCheckbox(u8g2_t *u8g2, u8g2_uint_t x, u8g2_uint_t y, u8g2_uint_t w, u8g2_uint_t is_checked) __attribute__((noinline));
...
u8g2_uint_t mui_get_x(mui_t *ui) __attribute__((noinline));
u8g2_uint_t mui_get_x(mui_t *ui)
{
  if ( ((mui_get_U8g2(ui))->width) >= 255 )
      return ui->x / 2;
  return ui->x;
}
...
void mui_u8g2_draw_button_pi(mui_t *ui, u8g2_uint_t width, u8g2_uint_t padding_h, const char *text)
{
  mui_u8g2_draw_button_utf(ui, mui_u8g2_get_pi_flags(ui), width, padding_h , 1, text);
}
...
void mui_u8g2_draw_button_fi(mui_t *ui, u8g2_uint_t width, u8g2_uint_t padding_h, const char *text)
{
  mui_u8g2_draw_button_utf(ui, mui_u8g2_get_fi_flags(ui), width, padding_h , 1, text);
}
...
void mui_u8g2_draw_button_pf(mui_t *ui, u8g2_uint_t width, u8g2_uint_t padding_h, const char *text)
{
  mui_u8g2_draw_button_utf(ui, mui_u8g2_get_pf_flags(ui), width, padding_h , 1, text);
}
...
void mui_u8g2_draw_button_if(mui_t *ui, u8g2_uint_t width, u8g2_uint_t padding_h, const char *text)
{
  mui_u8g2_draw_button_utf(ui, mui_u8g2_get_if_flags(ui), width, padding_h , 1, text);
}


static uint8_t mui_u8g2_handle_scroll_next_prev_events(mui_t *ui, uint8_t msg) __attribute__((noinline));
...
# 382 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/mui_u8g2.c"
uint8_t mui_u8g2_set_font_style_function(mui_t *ui, uint8_t msg)
{
  if ( msg == 1 )
  {
    u8g2_SetFont(mui_get_U8g2(ui), (uint8_t *)((ui->uif)->data));
  }
  return 0;
}
# 400 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/mui_u8g2.c"
uint8_t mui_u8g2_draw_text(mui_t *ui, uint8_t msg)
{
  switch(msg)
  {
...
# 455 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/mui_u8g2.c"
uint8_t mui_u8g2_btn_goto_wm_fi(mui_t *ui, uint8_t msg)
{
  switch(msg)
  {
    case 1:
      mui_u8g2_draw_button_utf(ui, 0x40 |mui_u8g2_get_fi_flags(ui), 0, 1, 1, ui->text);
      break;
    case 2:
      break;
    case 3:
...
uint8_t mui_u8g2_btn_goto_wm_if(mui_t *ui, uint8_t msg)
{
  ...
  {
    case 1:
      mui_u8g2_draw_button_utf(ui, 0x40 |mui_u8g2_get_if_flags(ui), 0, 1, 1, ui->text);
      break;
    case 2:
      break;
    case 3:
...
uint8_t mui_u8g2_btn_goto_w2_fi(mui_t *ui, uint8_t msg)
{
  ...
  {
    case 1:
      mui_u8g2_draw_button_utf(ui, 0x40 | mui_u8g2_get_fi_flags(ui), ((u8g2)->width)/2 - 10, 0, 1, ui->text);
      break;
    case 2:
      break;
    case 3:
...
uint8_t mui_u8g2_btn_goto_w2_if(mui_t *ui, uint8_t msg)
{
  ...
  {
    case 1:
      mui_u8g2_draw_button_utf(ui, 0x40 | mui_u8g2_get_if_flags(ui), ((u8g2)->width)/2 - 10, 0, 1, ui->text);
      break;
    case 2:
      break;
    case 3:
...
# 598 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/mui_u8g2.c"
uint8_t mui_u8g2_btn_exit_wm_fi(mui_t *ui, uint8_t msg)
{
  switch(msg)
  {
    ...
    case 7:
      {
        uint8_t *value = (uint8_t *)((ui->uif)->data);
        if ( value != ((void*)0) )
          *value = ui->arg;
      }
      mui_SaveForm(ui);
...
uint8_t mui_u8g2_btn_goto_w1_pi(mui_t *ui, uint8_t msg)
{
  ...
  {
    case 1:
      mui_u8g2_draw_button_pi(ui, ((u8g2)->width)-mui_get_x(ui)*2, mui_get_x(ui) , ui->text);
...
uint8_t mui_u8g2_btn_goto_w1_fi(mui_t *ui, uint8_t msg)
{
  ...
  {
    case 1:
      mui_u8g2_draw_button_fi(ui, ((u8g2)->width)-mui_get_x(ui)*2, mui_get_x(ui)-1 , ui->text);
...
static void mui_u8g2_u8_vmm_draw_wm_pi(mui_t *ui) __attribute__((noinline));
static void mui_u8g2_u8_vmm_draw_wm_pi(mui_t *ui)
{
  u8g2_t *u8g2 = mui_get_U8g2(ui);
  mui_u8g2_u8_min_max_t *vmm= (mui_u8g2_u8_min_max_t *)((ui->uif)->data);
  char buf[4] = "999";
  char *s = buf;
  uint8_t *value = ((vmm)->value);
  uint8_t min = ((vmm)->min);
  uint8_t max = ((vmm)->max);
  uint8_t cnt = 3;
...
static void mui_u8g2_u8_vmm_draw_wm_pf(mui_t *ui) __attribute__((noinline));
...
static void mui_u8g2_u8_bar_draw_wm(mui_t *ui, uint8_t flags) __attribute__((noinline));
static void mui_u8g2_u8_bar_draw_wm(mui_t *ui, uint8_t flags)
{
  u8g2_t *u8g2 = mui_get_U8g2(ui);
  mui_u8g2_u8_min_max_step_t *vmms= (mui_u8g2_u8_min_max_step_t *)((ui->uif)->data);
  char buf[4] = "999";
  char *s = buf;
  uint8_t *value = ((vmms)->value);
  uint8_t min = ((vmms)->min);
  uint8_t max = ((vmms)->max);
  uint8_t scale = 0;

  uint8_t mms_flags = ((vmms)->flags);
  uint8_t cnt = 3;
  uint8_t height = ((u8g2)->font_ref_ascent);
...
static uint8_t mui_is_valid_char(uint8_t c) __attribute__((noinline));
...
uint8_t mui_u8g2_u8_char_wm_mud_pi(mui_t *ui, uint8_t msg)
{
  ...
  switch(msg)
  {
    case 1:
      ...
      buf[0] = *value;
      buf[1] = '\0';
      mui_u8g2_draw_button_pi(ui, ((u8g2)->font_info.max_char_width), 1, buf);
...
# 1280 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/mui_u8g2.c"
uint8_t mui_u8g2_u8_opt_line_wa_mse_pi(mui_t *ui, uint8_t msg)
{
...
# 1504 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/mui_u8g2.c"
uint8_t mui_u8g2_u8_chkbox_wm_pi(mui_t *ui, uint8_t msg)
{
  u8g2_t *u8g2 = mui_get_U8g2(ui);
  u8g2_uint_t flags = 0;
  ...
  switch(msg)
  {
    case 1:
      ...
      {
        u8g2_uint_t w = 0;
        u8g2_uint_t a = ((u8g2)->font_ref_ascent);
        if ( *value )
...
uint8_t mui_u8g2_u8_opt_radio_child_wm_pi(mui_t *ui, uint8_t msg)
{
  ...
  switch(msg)
  {
    case 1:
      {
        u8g2_uint_t w = 0;
        u8g2_uint_t a = ((u8g2)->font_ref_ascent) - 2;
        u8g2_uint_t x = mui_get_x(ui);
        u8g2_uint_t y = mui_get_y(ui);
        uint8_t is_focus = ((ui)->dflags & 0x01);
        ...
        if ( is_focus )
        {
          u8g2_DrawButtonFrame(u8g2, x, y, 0x20, w+a, 1, 1);
        }
      }
      break;
    default:
    ...
    case 1:
      {
        ...
        if ( is_focus )
        {
          u8g2_DrawButtonFrame(u8g2, 0, y, 0x20, ((u8g2)->width), 0, 1);
        }
      }
      break;
    default:
    ...
    case 1:
      {
        ...
        if ( ui->text[0] != '\0' )
        {
          u8g2_DrawButtonUTF8(u8g2, x, y, flags, 0, 1, 1, ui->text);
        }
      }
      break;
    default:
...
# 1840 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/mui_u8g2.c"
uint8_t mui_u8g2_goto_data(mui_t *ui, uint8_t msg)
{
  switch(msg)
  {
  ...
  switch(msg)
  {
    case 1:
      if ( mui_GetSelectableFieldTextOption(ui, ui->last_form_fds, arg + ui->form_scroll_top) )
        mui_u8g2_draw_button_pi(ui, ((u8g2)->width)-mui_get_x(ui)*2, mui_get_x(ui), ui->text+1);
      break;
    case 5:
      if ( mui_GetSelectableFieldTextOption(ui, ui->last_form_fds, ui->arg + ui->form_scroll_top) )
      {
        mui_SaveCursorPosition(ui, ui->arg + ui->form_scroll_top);
...
uint8_t mui_u8g2_goto_form_w1_pf(mui_t *ui, uint8_t msg)
{
  ...
  switch(msg)
  {
    case 1:
      if ( mui_GetSelectableFieldTextOption(ui, ui->last_form_fds, arg + ui->form_scroll_top) )
        mui_u8g2_draw_button_pf(ui, ((u8g2)->width)-mui_get_x(ui)*2, mui_get_x(ui)-1, ui->text+1);
      break;
    case 5:
      if ( mui_GetSelectableFieldTextOption(ui, ui->last_form_fds, ui->arg + ui->form_scroll_top) )
      {
...
uint8_t mui_u8g2_u16_list_line_wa_mse_pi(mui_t *ui, uint8_t msg)
{
  ...
  mui_u8g2_list_t *list = (mui_u8g2_list_t *)((ui->uif)->data);
  uint16_t *selection = ((list)->selection);
  void *data = ((list)->data);
  mui_u8g2_get_list_element_cb element_cb = ((list)->get_list_element);
  mui_u8g2_get_list_count_cb count_cb = ((list)->get_list_count);
...
uint8_t mui_u8g2_u16_list_parent_wm_pi(mui_t *ui, uint8_t msg)
{
  ...
  switch(msg)
  {
    ...
    case 7:
      mui_SaveForm(ui);
      mui_GotoForm(ui, ui->arg, *selection);
      break;
    case 8:
      break;
    case 9:
...
uint8_t mui_u8g2_u16_list_goto_w1_pi(mui_t *ui, uint8_t msg)
{
  ...
  {
    case 1:
      mui_u8g2_draw_button_pi(ui, ((u8g2)->width)-mui_get_x(ui)*2, mui_get_x(ui), element_cb(data, pos)+1);
    ...
    case 7:
      if ( selection != ((void*)0) )
        *selection = pos;
      mui_SaveCursorPosition(ui, pos >= 255 ? 0 : pos);
