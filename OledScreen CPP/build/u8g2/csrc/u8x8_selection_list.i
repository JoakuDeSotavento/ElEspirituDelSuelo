# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_selection_list.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_selection_list.c" 2
# 38 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_selection_list.c"
...
# 39 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_selection_list.c" 2
...
void u8x8_sl_string_line_cb(u8x8_t *u8x8, u8sl_t *u8sl, uint8_t idx, const void *aux)
{
  ...
  if ( s == ((void*)0) )
    s = "";
  u8x8_DrawUTF8Line(u8x8, u8sl->x, row, ((u8x8)->display_info->tile_width), s);
  (u8x8)->is_font_inverse_mode = (0);
}
# 121 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_selection_list.c"
uint8_t u8x8_UserInterfaceSelectionList(u8x8_t *u8x8, const char *title, uint8_t start_pos, const char *sl)
{
  u8sl_t u8sl;
  uint8_t event;
  ...
  u8sl.visible = ((u8x8)->display_info->tile_height);
  ...
  if ( title != ((void*)0) )
  {
    title_lines = u8x8_DrawUTF8Lines(u8x8, u8sl.x, u8sl.y, ((u8x8)->display_info->tile_width), title);
    u8sl.y+=title_lines;
