# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8log_u8g2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8log_u8g2.c" 2
# 37 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8log_u8g2.c"
...
# 38 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8log_u8g2.c" 2
# 51 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8log_u8g2.c"
void u8g2_DrawLog(u8g2_t *u8g2, u8g2_uint_t x, u8g2_uint_t y, u8log_t *u8log)
{
  ...
  for( buf_y = 0; buf_y < u8log->height; buf_y++ )
  {
    ...
    disp_y += ((u8g2)->font_ref_ascent) - ((u8g2)->font_ref_descent);
    disp_y += u8log->line_height_offset;
  }
}
# 85 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8log_u8g2.c"
void u8log_u8g2_cb(u8log_t * u8log)
{
  ...
  if ( u8log->is_redraw_line || u8log->is_redraw_all )
  {
    ...
    do
    {
      u8g2_DrawLog( u8g2, 0, ((u8g2)->font_ref_ascent), u8log);
    }
