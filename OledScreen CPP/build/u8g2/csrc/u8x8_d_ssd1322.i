# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1322.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1322.c" 2
# 41 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1322.c"
...
# 42 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1322.c" 2
...
# 91 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1322.c"
static uint8_t u8x8_ssd1322_to32_dest_buf[32];

static uint8_t *u8x8_ssd1322_8to32(__attribute__((unused)) u8x8_t *u8x8, uint8_t *ptr)
{
  uint8_t v;
  uint8_t a,b;
  uint8_t i, j;
...
static uint8_t *u8x8_ssd1322_4to32(__attribute__((unused)) u8x8_t *u8x8, uint8_t *ptr)
{
  uint8_t v;
  uint8_t a;
  uint8_t i, j;
...
uint8_t u8x8_d_ssd1322_common(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
# 166 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1322.c"
    case 11:
      if ( arg_int == 0 )
...
static const uint8_t u8x8_d_ssd1322_256x64_init_seq[] = {
  ...
  (21), (0xa0), (22), (0x06), (22), (0x011),
  (21), (0xab), (22), (0x01),
  (21), (0xb4), (22), (0xa0), (22), (0x005|0x0fd),
  (21), (0xc1), (22), (0x9f),
  (21), (0xc7), (22), (0x0f),
  (21), (0xb9),
  (21), (0xb1), (22), (0xe2),
  (21), (0xd1), (22), (0x082|0x020), (22), (0x020),
  (21), (0xbb), (22), (0x1f),
  (21), (0xb6), (22), (0x08),
  (21), (0xbe), (22), (0x07),
  (21), (0xa6),
...
# 439 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1322.c"
uint8_t u8x8_d_ssd1322_common2(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
# 455 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1322.c"
    case 11:
      if ( arg_int == 0 )
 u8x8_cad_SendSequence(u8x8, u8x8_d_ssd1322_powersave0_seq);
      else
...
static const uint8_t u8x8_d_ssd1322_128x64_init_seq[] = {
  ...
  (21), (0xa1), (22), (0x00),
  (21), (0xab), (22), (0x01),
# 601 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1322.c"
  (21), (0xa0), (22), (0x16), (22), (0x011),
  (21), (0xc7), (22), (0x0f),
  (21), (0xc1), (22), (0x9f),
