# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_st75256.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_st75256.c" 2
# 61 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_st75256.c"
...
# 62 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_st75256.c" 2
...
static uint8_t u8x8_d_st75256_256x128_generic(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
# 174 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_st75256.c"
    case 11:
      if ( arg_int == 0 )
    ...
    case 14:
      ...
      u8x8_cad_SendArg(u8x8, (arg_int & 0x1f)<<1 );
      u8x8_cad_SendArg(u8x8, (arg_int>>5));
    ...
    case 15:
      ...
      u8x8_cad_SendArg(u8x8, u8x8->x_offset + (((u8x8_tile_t *)arg_ptr)->y_pos));
...
static const uint8_t u8x8_d_st75256_256x160_init_seq[] = {
  ...
  (21), (0x030),
  (21), (0x75), (22), (0), (22), (0x28),
  (21), (0x15), (22), (0), (22), (0xFF),
...
uint8_t u8x8_d_st75256_jlx19296(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
 ...
 case 13:
     ...
     return 1;
# 1760 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_st75256.c"
        case 14:
...
uint8_t u8x8_d_st75256_jlx16080(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
 ...
 case 13:
     ...
     return 1;
# 1964 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_st75256.c"
        case 14:
