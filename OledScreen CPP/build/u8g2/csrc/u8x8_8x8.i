# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_8x8.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_8x8.c" 2
# 38 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_8x8.c"
...
# 39 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_8x8.c" 2
# 50 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_8x8.c"
void u8x8_SetFont(u8x8_t *u8x8, const uint8_t *font_8x8)
{
  u8x8->font = font_8x8;
}
...
static void u8x8_get_glyph_data(u8x8_t *u8x8, uint8_t encoding, uint8_t *buf, uint8_t tile_offset) __attribute__((noinline));
...
# 153 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_8x8.c"
...
static void u8x8_upscale_buf(uint8_t *src, uint8_t *dest) __attribute__((noinline));
...
# 285 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_8x8.c"
void u8x8_utf8_init(u8x8_t *u8x8)
{
  u8x8->utf8_state = 0;
}

uint16_t u8x8_ascii_next(__attribute__((unused)) u8x8_t *u8x8, uint8_t b)
{
  if ( b == 0 || b == '\n' )
    return 0x0ffff;
  return b;
}
# 304 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_8x8.c"
uint16_t u8x8_utf8_next(u8x8_t *u8x8, uint8_t b)
{
  if ( b == 0 || b == '\n' )
    return 0x0ffff;
...
static uint8_t u8x8_draw_string(u8x8_t *u8x8, uint8_t x, uint8_t y, const char *s) __attribute__((noinline));
...
static uint8_t u8x8_draw_2x2_string(u8x8_t *u8x8, uint8_t x, uint8_t y, const char *s) __attribute__((noinline));
...
static uint8_t u8x8_draw_1x2_string(u8x8_t *u8x8, uint8_t x, uint8_t y, const char *s) __attribute__((noinline));
