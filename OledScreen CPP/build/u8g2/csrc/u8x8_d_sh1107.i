# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_sh1107.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_sh1107.c" 2
# 37 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_sh1107.c"
...
# 38 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_sh1107.c" 2
...
static uint8_t u8x8_d_sh1107_HJR_OEL1M0201_generic(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
# 90 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_sh1107.c"
    case 11:
      if ( arg_int == 0 )
 ...
 u8x8->x_offset = u8x8->display_info->flipmode_x_offset;
    ...
    case 15:
      ...
      u8x8_cad_SendCmd(u8x8, 0x0b0 | (2+(((u8x8_tile_t *)arg_ptr)->y_pos)));
...
# 144 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_sh1107.c"
 arg_int--;
      } while( arg_int > 0 );
...
static uint8_t u8x8_d_sh1107_generic(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
# 172 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_sh1107.c"
    case 11:
      if ( arg_int == 0 )
 u8x8_cad_SendSequence(u8x8, u8x8_d_sh1107_64x128_noname_powersave0_seq);
      else
 ...
 ptr = ((u8x8_tile_t *)arg_ptr)->tile_ptr;
 u8x8_cad_SendData(u8x8, c*8, ptr);
# 226 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_sh1107.c"
 arg_int--;
      } while( arg_int > 0 );
...
# 654 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_sh1107.c"
...
static uint8_t u8x8_d_sh1107_TK078F288_generic(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
# 754 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_sh1107.c"
    case 11:
      if ( arg_int == 0 )
 u8x8_cad_SendSequence(u8x8, u8x8_d_sh1107_64x128_noname_powersave0_seq);
      else
 ...
 ptr = ((u8x8_tile_t *)arg_ptr)->tile_ptr;
 u8x8_cad_SendData(u8x8, c*8, ptr);
# 808 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_sh1107.c"
 arg_int--;
      } while( arg_int > 0 );
