# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ks0108.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ks0108.c" 2
# 38 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ks0108.c"
...
# 39 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ks0108.c" 2
...
static void u8x8_ks0108_out(u8x8_t *u8x8, struct u8x8_ks0108_vars *v, void *arg_ptr)
{
 ...
 cnt = v->c;
      ...
      v->c-=cnt;
      cnt<<=3;
      u8x8_cad_SendData(u8x8, cnt, v->ptr);
      v->ptr += cnt;
...
uint8_t u8x8_d_ks0108_128x64(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
    ...
    case 10:
      ...
      u8x8->cad_cb(u8x8, 24, 1, ((void*)0));
      u8x8_cad_SendSequence(u8x8, u8x8_d_ks0108_init_seq);
      u8x8->cad_cb(u8x8, 25, 0, ((void*)0));

      u8x8->cad_cb(u8x8, 24, 2, ((void*)0));
      u8x8_cad_SendSequence(u8x8, u8x8_d_ks0108_init_seq);
      u8x8->cad_cb(u8x8, 25, 0, ((void*)0));
      break;
    case 11:
...
uint8_t u8x8_d_ks0108_erm19264(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
    ...
    case 10:
      ...
      u8x8->cad_cb(u8x8, 24, 3, ((void*)0));
      u8x8_cad_SendSequence(u8x8, u8x8_d_ks0108_init_seq);
      u8x8->cad_cb(u8x8, 25, 7, ((void*)0));

      u8x8->cad_cb(u8x8, 24, 5, ((void*)0));
      u8x8_cad_SendSequence(u8x8, u8x8_d_ks0108_init_seq);
      u8x8->cad_cb(u8x8, 25, 7, ((void*)0));

      u8x8->cad_cb(u8x8, 24, 6, ((void*)0));
      u8x8_cad_SendSequence(u8x8, u8x8_d_ks0108_init_seq);
      u8x8->cad_cb(u8x8, 25, 7, ((void*)0));
      break;
    case 11:
 ...
 u8x8->cad_cb(u8x8, 25, 7, ((void*)0));
    ...
    case 15:
      ...
      v.c = ((u8x8_tile_t *)arg_ptr)->cnt;
      v.arg_int = arg_int;
# 320 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ks0108.c"
      if ( v.x < 8 )
      {
 u8x8->cad_cb(u8x8, 24, 6, ((void*)0));
 u8x8_ks0108_out(u8x8, &v, arg_ptr);
