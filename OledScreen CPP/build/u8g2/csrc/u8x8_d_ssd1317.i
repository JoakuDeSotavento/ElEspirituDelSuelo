# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1317.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1317.c" 2
# 42 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1317.c"
...
# 43 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1317.c" 2
...
static uint8_t u8x8_d_ssd1317_generic(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
# 134 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1317.c"
    case 11:
      if ( arg_int == 0 )
...
# 186 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1317.c"
 arg_int--;
      } while( arg_int > 0 );
