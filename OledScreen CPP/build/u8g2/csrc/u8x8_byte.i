# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_byte.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_byte.c" 2
# 37 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_byte.c"
...
# 38 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_byte.c" 2

uint8_t u8x8_byte_SetDC(u8x8_t *u8x8, uint8_t dc)
{
  return u8x8->byte_cb(u8x8, 32, dc, ((void*)0));
}
...
uint8_t u8x8_byte_StartTransfer(u8x8_t *u8x8)
{
  return u8x8->byte_cb(u8x8, 24, 0, ((void*)0));
}

uint8_t u8x8_byte_EndTransfer(u8x8_t *u8x8)
{
  return u8x8->byte_cb(u8x8, 25, 0, ((void*)0));
}



uint8_t u8x8_byte_empty(__attribute__((unused)) u8x8_t *u8x8, uint8_t msg, __attribute__((unused)) uint8_t arg_int, __attribute__((unused)) void *arg_ptr)
{
  switch(msg)
  {
    case 23:
...
# 107 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_byte.c"
uint8_t u8x8_byte_4wire_sw_spi(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  uint8_t i, b;
  uint8_t *data;
 ...
 for( i = 0; i < 8; i++ )
 {
   ...
   u8x8_gpio_call((u8x8), (44), (u8x8->display_info->sck_pulse_width_ns));
    ...
    case 24:
      ...
      u8x8->gpio_and_delay_cb(u8x8, 44, u8x8->display_info->post_chip_enable_wait_ns, ((void*)0));
      break;
    case 25:
      u8x8->gpio_and_delay_cb(u8x8, 44, u8x8->display_info->pre_chip_disable_wait_ns, ((void*)0));
      u8x8_gpio_call(u8x8, (64+(9)), (u8x8->display_info->chip_disable_level));
      break;
    default:
      return 0;
...
# 460 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_byte.c"
