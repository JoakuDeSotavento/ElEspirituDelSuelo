# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_polygon.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_polygon.c" 2
...
# 9 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_polygon.c" 2
...
# 54 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_polygon.c"
struct _pg_struct
{
...
static uint8_t pge_Next(struct pg_edge_struct *pge) __attribute__((noinline));
static uint8_t pg_inc(pg_struct *pg, uint8_t i) __attribute__((noinline));
static uint8_t pg_dec(pg_struct *pg, uint8_t i) __attribute__((noinline));
static void pg_expand_min_y(pg_struct *pg, pg_word_t min_y, uint8_t pge_idx) __attribute__((noinline));
static void pg_line_init(pg_struct * const pg, uint8_t pge_index) __attribute__((noinline));
...
void u8g2_AddPolygonXY(__attribute__((unused)) u8g2_t *u8g2, int16_t x, int16_t y)
{
