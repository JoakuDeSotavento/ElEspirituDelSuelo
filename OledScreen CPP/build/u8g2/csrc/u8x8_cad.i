# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_cad.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_cad.c" 2
# 86 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_cad.c"
...
# 87 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_cad.c" 2

uint8_t u8x8_cad_SendCmd(u8x8_t *u8x8, uint8_t cmd)
{
  return u8x8->cad_cb(u8x8, 21, cmd, ((void*)0));
}

uint8_t u8x8_cad_SendArg(u8x8_t *u8x8, uint8_t arg)
{
  return u8x8->cad_cb(u8x8, 22, arg, ((void*)0));
}
...
uint8_t u8x8_cad_SendMultipleArg(u8x8_t *u8x8, uint8_t cnt, uint8_t arg)
{
  while( cnt > 0 )
  {
    u8x8->cad_cb(u8x8, 22, arg, ((void*)0));
    cnt--;
  }
  return 1;
}
...
{
  return u8x8->cad_cb(u8x8, 24, 0, ((void*)0));
}

uint8_t u8x8_cad_EndTransfer(u8x8_t *u8x8)
{
  return u8x8->cad_cb(u8x8, 25, 0, ((void*)0));
}
...
void u8x8_cad_vsendf(u8x8_t * u8x8, const char *fmt, va_list va)
{
  ...
  while( *fmt != '\0' )
  {
    d = (uint8_t)__builtin_va_arg(va, int);
    switch(*fmt)
    {
...
# 159 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_cad.c"
void u8x8_cad_SendSequence(u8x8_t *u8x8, uint8_t const *data)
{
  uint8_t cmd;
  uint8_t v;
...
# 473 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_cad.c"
static void u8x8_i2c_data_transfer(u8x8_t *u8x8, uint8_t arg_int, void *arg_ptr) __attribute__((noinline));
...
uint8_t u8x8_cad_ssd13xx_i2c(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
    ...
    case 22:
      ...
      break;
    case 23:
# 508 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_cad.c"
      p = arg_ptr;
       while( arg_int > 24 )
      {
...
uint8_t u8x8_cad_ssd13xx_fast_i2c(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  u8x8_byte_EndTransfer(u8x8);
      ...
      u8x8_byte_SendByte(u8x8, arg_int);
      in_transfer = 1;
# 562 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_cad.c"
      break;
    case 22:
      u8x8_byte_SendByte(u8x8, arg_int);
      break;
    case 23:
      if ( in_transfer != 0 )
 u8x8_byte_EndTransfer(u8x8);
# 578 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_cad.c"
      p = arg_ptr;
       while( arg_int > 24 )
      {
 u8x8_i2c_data_transfer(u8x8, 24, p);
...
uint8_t u8x8_cad_ld7032_i2c(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
 ...
 u8x8_byte_EndTransfer(u8x8);
    ...
    case 22:
      ...
      break;
    case 23:
# 683 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_cad.c"
      p = arg_ptr;
       while( arg_int > 24 )
      {
