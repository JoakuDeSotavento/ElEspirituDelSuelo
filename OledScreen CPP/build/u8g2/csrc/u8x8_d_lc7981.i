# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_lc7981.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_lc7981.c" 2
# 37 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_lc7981.c"
...
# 38 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_lc7981.c" 2
# 70 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_lc7981.c"
...
static uint8_t u8x8_d_lc7981_common(u8x8_t *u8x8, uint8_t msg, __attribute__((unused)) uint8_t arg_int, void *arg_ptr)
{
  uint8_t c, i, j;
  uint16_t y;
  uint8_t *ptr;
...
# 107 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_lc7981.c"
      c = ((u8x8_tile_t *)arg_ptr)->cnt;
      ptr = ((u8x8_tile_t *)arg_ptr)->tile_ptr;
      for( i = 0; i < 8; i++ )
      {
 u8x8_cad_SendCmd(u8x8, 0x0a );
 u8x8_cad_SendArg(u8x8, y&255);
 u8x8_cad_SendCmd(u8x8, 0x0b );
 u8x8_cad_SendArg(u8x8, y>>8);

 u8x8_cad_SendCmd(u8x8, 0x0c );
# 125 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_lc7981.c"
 for( j = 0; j < c; j++ )
 ...
 y += u8x8->display_info->tile_width;
      ...
      break;
# 177 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_lc7981.c"
    default:
      return 0;
  }
  return 1;
