# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_sed1330.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_sed1330.c" 2
# 44 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_sed1330.c"
...
# 45 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_sed1330.c" 2
...
uint8_t u8x8_d_sed1330_common(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
 ...
 u8x8_cad_SendSequence(u8x8, u8x8_d_sed1330_powersave1_seq);
    ...
    case 15:
      ...
      for( i = 0; i < 8; i++ )
      {
 u8x8_cad_SendCmd(u8x8, 0x046 );
 u8x8_cad_SendArg(u8x8, y&255);
 u8x8_cad_SendArg(u8x8, y>>8);
 u8x8_cad_SendCmd(u8x8, 0x042 );
 ...
 y += u8x8->display_info->tile_width;
      ...
      u8x8_cad_SendCmd(u8x8, 0x059 );
      u8x8_cad_SendArg(u8x8, 0x004);
