# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1320.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1320.c" 2
# 50 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1320.c"
...
# 51 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1320.c" 2
...
# 75 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1320.c"
static uint8_t u8x8_ssd1320_to32_dest_buf[32];



static uint8_t *u8x8_ssd1320_8to32(__attribute__((unused)) u8x8_t *u8x8, uint8_t *ptr)
{
  uint8_t v;
  uint8_t a,b;
  uint8_t i, j;
...
uint8_t u8x8_d_ssd1320_common(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
# 124 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1320.c"
    case 11:
      if ( arg_int == 0 )
...
static uint8_t *u8x8_ssd1320_8to32_2(__attribute__((unused)) u8x8_t *u8x8, uint8_t *ptr)
{
  uint8_t v;
  uint8_t a,b;
  uint8_t i, j;
...
uint8_t u8x8_d_ssd1320_common_2(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
# 230 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1320.c"
    case 11:
      if ( arg_int == 0 )
       u8x8_cad_SendSequence(u8x8, u8x8_d_ssd1320_cs1_160x132_nhd_powersave0_seq);
      else
...
# 529 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1320.c"
...
# 613 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1320.c"
