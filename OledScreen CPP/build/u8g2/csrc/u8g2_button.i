# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_button.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_button.c" 2
# 36 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_button.c"
...
# 37 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_button.c" 2
# 98 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_button.c"
void u8g2_DrawButtonFrame(u8g2_t *u8g2, u8g2_uint_t x, u8g2_uint_t y, u8g2_uint_t flags, u8g2_uint_t text_width, u8g2_uint_t padding_h, u8g2_uint_t padding_v)
{
  ...
  u8g2_uint_t gap_frame = 7 +1;

  u8g2_uint_t border_width = flags & 7;

  int8_t a = ((u8g2)->font_ref_ascent);
  int8_t d = ((u8g2)->font_ref_descent);
  ...
  for(;;)
  {
    ...
    if ( flags & 0x18 )
    {
      if ( border_width == (flags & 7) )
      {
        u8g2_uint_t i;
        u8g2_uint_t shadow_gap = (flags & 0x18) >> 3;
        shadow_gap--;
