# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_input_value.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_input_value.c" 2
# 36 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_input_value.c"
...
# 37 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_input_value.c" 2
...
uint8_t u8x8_UserInterfaceInputValue(u8x8_t *u8x8, const char *title, const char *pre, uint8_t *value, uint8_t lo, uint8_t hi, uint8_t digits, const char *post)
{
  ...
  if ( width < ((u8x8)->display_info->tile_width) )
  {
    x = ((u8x8)->display_info->tile_width);
    x -= width;
    x /= 2;
  }
  ...
  y += u8x8_DrawUTF8Lines(u8x8, 0, y, ((u8x8)->display_info->tile_width), title);
