# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_a2printer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_a2printer.c" 2
# 42 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_a2printer.c"
...
# 43 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_a2printer.c" 2
# 54 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_a2printer.c"
...
uint8_t u8x8_d_a2printer_common(u8x8_t *u8x8, uint8_t msg, __attribute__((unused)) uint8_t arg_int, void *arg_ptr)
{
  uint8_t c, i, j;
  uint8_t *ptr;
  ...
  switch(msg)
  {
    ...
    case 15:
      ...
      u8x8_cad_SendCmd(u8x8, 27);
      u8x8_cad_SendCmd(u8x8, 55 );

      u8x8_cad_SendCmd(u8x8, 0);
      u8x8_cad_SendCmd(u8x8, 200);
      u8x8_cad_SendCmd(u8x8, 2);


      c = u8x8->display_info->tile_width;
      ptr = ((u8x8_tile_t *)arg_ptr)->tile_ptr;

      u8x8_cad_SendCmd(u8x8, 18);
      u8x8_cad_SendCmd(u8x8, 42 );
      u8x8_cad_SendCmd(u8x8, 8 );
      u8x8_cad_SendCmd(u8x8, c );
 ...
 {
   u8x8->gpio_and_delay_cb(u8x8, 41, 200, ((void*)0));
   delay_in_milliseconds -= 200;
 }
 u8x8->gpio_and_delay_cb(u8x8, 41, delay_in_milliseconds, ((void*)0));
      }


      u8x8_cad_SendCmd(u8x8, 27);
      u8x8_cad_SendCmd(u8x8, 55 );
      u8x8_cad_SendCmd(u8x8, 7);
      u8x8_cad_SendCmd(u8x8, 80);
      u8x8_cad_SendCmd(u8x8, 2);
