# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_input_value.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_input_value.c" 2
# 36 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_input_value.c"
...
# 37 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_input_value.c" 2
 ...
 *value = local_value;
 ...
 return 0;
      ...
      else if ( event == (64+(17)) || event == (64+(20)) )
      {
 if ( local_value >= hi )
   local_value = lo;
 else
 ...
 break;
      ...
      else if ( event == (64+(18)) || event == (64+(21)) )
      {
 if ( local_value <= lo )
   local_value = hi;
 else
