# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_max7219.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_max7219.c" 2
# 37 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_max7219.c"
...
# 38 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_max7219.c" 2
...
static uint8_t u8x8_d_max7219_generic(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
# 132 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_max7219.c"
    case 14:
      u8x8_cad_StartTransfer(u8x8);
      for( i = 0; i < u8x8->display_info->tile_width; i++ )
      {
 u8x8_cad_SendCmd(u8x8, 10 );
 u8x8_cad_SendArg(u8x8, (arg_int>>4) );
      }
...
# 250 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_max7219.c"
uint8_t u8x8_d_max7219_16x16(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  switch(msg)
  {
