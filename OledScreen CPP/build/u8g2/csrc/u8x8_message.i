# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_message.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_message.c" 2
# 36 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_message.c"
...
# 37 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_message.c" 2
...
# 88 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_message.c"
uint8_t u8x8_UserInterfaceMessage(u8x8_t *u8x8, const char *title1, const char *title2, const char *title3, const char *buttons)
{
  uint8_t height;
  uint8_t y;
  ...
  y = 0;
  if ( height < ((u8x8)->display_info->tile_height) )
  {
    y = ((u8x8)->display_info->tile_height);
    y -= height;
    y /= 2;
  }
  ...
  y += u8x8_DrawUTF8Lines(u8x8, 0, y, ((u8x8)->display_info->tile_width), title1);
  if ( title2 != ((void*)0) )
  {
    u8x8_DrawUTF8Line(u8x8, 0, y, ((u8x8)->display_info->tile_width), title2);
    y++;
  }
  y += u8x8_DrawUTF8Lines(u8x8, 0, y, ((u8x8)->display_info->tile_width), title3);

  button_cnt = u8x8_draw_button_line(u8x8, y, ((u8x8)->display_info->tile_width), cursor, buttons);
 ...
 cursor = 0;
      u8x8_draw_button_line(u8x8, y, ((u8x8)->display_info->tile_width), cursor, buttons);
    }
