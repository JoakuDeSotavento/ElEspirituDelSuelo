# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_debounce.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_debounce.c" 2
# 38 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_debounce.c"
...
# 39 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_debounce.c" 2
...
# 140 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_debounce.c"
#pragma weak u8x8_GetMenuEvent

uint8_t u8x8_GetMenuEvent(u8x8_t *u8x8)
{
  uint8_t pin_state;
  uint8_t result_msg = 0;
 ...
 u8x8->debounce_state = 0x030;
    ...
    case 0x30:
      ...
      {
 u8x8->debounce_state = 0x00;
 result_msg = (64+(u8x8_find_first_diff(u8x8->debounce_default_pin_state, u8x8->debounce_last_pin_state)+16));
      }
      else
      {
