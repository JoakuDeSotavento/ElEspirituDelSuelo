# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_setup.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_setup.c" 2
# 37 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_setup.c"
...
# 38 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_setup.c" 2


uint8_t u8x8_dummy_cb(__attribute__((unused)) u8x8_t *u8x8, __attribute__((unused)) uint8_t msg, __attribute__((unused)) uint8_t arg_int, __attribute__((unused)) void *arg_ptr)
{
...
uint8_t u8x8_d_null_cb(u8x8_t *u8x8, uint8_t msg, __attribute__((unused)) uint8_t arg_int, __attribute__((unused)) void *arg_ptr)
{
  switch(msg)
  {
    case 9:
...
# 95 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_setup.c"
void u8x8_SetupDefaults(u8x8_t *u8x8)
{
    u8x8->display_info = ((void*)0);
...
# 133 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_setup.c"
void u8x8_Setup(u8x8_t *u8x8, u8x8_msg_cb display_cb, u8x8_msg_cb cad_cb, u8x8_msg_cb byte_cb, u8x8_msg_cb gpio_and_delay_cb)
{
