# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_font.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_font.c" 2
# 36 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_font.c"
...
# 37 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_font.c" 2
# 94 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_font.c"
...
# 111 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_font.c"
...
static uint16_t u8g2_font_get_word(const uint8_t *font, uint8_t offset) __attribute__((noinline));
static uint16_t u8g2_font_get_word(const uint8_t *font, uint8_t offset)
{
    uint16_t pos;
    font += offset;
    pos = (*(const uint8_t *)(font));
    font++;
    pos <<= 8;
    pos += (*(const uint8_t *)(font));
    return pos;
...
size_t u8g2_GetFontSize(const uint8_t *font_arg)
{
  ...
  for(;;)
  {
    if ( (*(const uint8_t *)(font + 1)) == 0 )
      break;
    font += (*(const uint8_t *)(font + 1));
  }
  ...
  for(;;)
  {
    e = (*(const uint8_t *)(font));
    e <<= 8;
    e |= (*(const uint8_t *)(font + 1));
    if ( e == 0 )
      break;
    font += (*(const uint8_t *)(font + 2));
  }
...
int8_t u8g2_GetFontBBXOffX(u8g2_t *u8g2) __attribute__((noinline));
int8_t u8g2_GetFontBBXOffX(u8g2_t *u8g2)
{
  return u8g2->font_info.x_offset;
}

int8_t u8g2_GetFontBBXOffY(u8g2_t *u8g2) __attribute__((noinline));
int8_t u8g2_GetFontBBXOffY(u8g2_t *u8g2)
{
  return u8g2->font_info.y_offset;
}

uint8_t u8g2_GetFontCapitalAHeight(u8g2_t *u8g2) __attribute__((noinline));
...
uint8_t u8g2_font_decode_get_unsigned_bits(u8g2_font_decode_t *f, uint8_t cnt)
{
  ...
  val = (*(const uint8_t *)(f->decode_ptr));
  ...
  if ( bit_pos_plus_cnt >= 8 )
  {
    ...
    val |= (*(const uint8_t *)(f->decode_ptr)) << (s);
...
# 282 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_font.c"
...
# 387 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_font.c"
...
# 442 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_font.c"
    if ( is_foreground )
    {
 ...
 current,
    ...
    {
      u8g2->draw_color = decode->bg_color;
      u8g2_DrawHVLine(u8g2,
 x,
 y,
 current,
...
# 612 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_font.c"
...
# 642 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_font.c"
    {
...
# 782 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_font.c"
const uint8_t *u8g2_font_get_glyph_data(u8g2_t *u8g2, uint16_t encoding)
{
  ...
  if ( encoding <= 255 )
  {
    ...
    for(;;)
    {
      if ( (*(const uint8_t *)(font + 1)) == 0 )
 break;
      if ( (*(const uint8_t *)(font)) == encoding )
      {
 return font+2;
      }
      font += (*(const uint8_t *)(font + 1));
...
# 825 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_font.c"
...
uint8_t u8g2_IsGlyph(u8g2_t *u8g2, uint16_t requested_encoding)
{
  ...
  if ( u8g2_font_get_glyph_data(u8g2, requested_encoding) != ((void*)0) )
    return 1;
  return 0;
}
...
# 931 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_font.c"
void u8g2_SetFontMode(u8g2_t *u8g2, uint8_t is_transparent)
{
...
static u8g2_uint_t u8g2_draw_string(u8g2_t *u8g2, u8g2_uint_t x, u8g2_uint_t y, const char *str) __attribute__((noinline));
static u8g2_uint_t u8g2_draw_string(u8g2_t *u8g2, u8g2_uint_t x, u8g2_uint_t y, const char *str)
{
  uint16_t e;
  u8g2_uint_t delta, sum;
  u8x8_utf8_init(((u8x8_t *)(u8g2)));
  sum = 0;
  for(;;)
  {
    e = u8g2->u8x8.next_cb(((u8x8_t *)(u8g2)), (uint8_t)*str);
    if ( e == 0x0ffff )
      break;
    str++;
    if ( e != 0x0fffe )
...
# 1010 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_font.c"
      sum += delta;
    }
  }
  return sum;
...
static u8g2_uint_t u8g2_draw_string_2x(u8g2_t *u8g2, u8g2_uint_t x, u8g2_uint_t y, const char *str) __attribute__((noinline));
...
# 1061 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_font.c"
u8g2_uint_t u8g2_DrawUTF8(u8g2_t *u8g2, u8g2_uint_t x, u8g2_uint_t y, const char *str)
{
...
void u8g2_UpdateRefHeight(u8g2_t *u8g2)
{
  ...
  else if ( u8g2->font_height_mode == 1 )
  {
...
void u8g2_SetFontRefHeightExtendedText(u8g2_t *u8g2)
{
  u8g2->font_height_mode = 1;
  u8g2_UpdateRefHeight(u8g2);
}

void u8g2_SetFontRefHeightAll(u8g2_t *u8g2)
{
  u8g2->font_height_mode = 2;
  u8g2_UpdateRefHeight(u8g2);
}
...
u8g2_uint_t u8g2_font_calc_vref_font(__attribute__((unused)) u8g2_t *u8g2)
{
  return 0;
}
...
static uint8_t u8g2_is_all_valid(u8g2_t *u8g2, const char *str) __attribute__((noinline));
static uint8_t u8g2_is_all_valid(u8g2_t *u8g2, const char *str)
{
  ...
  for(;;)
  {
    ...
    if ( e != 0x0fffe )
    {
      if ( u8g2_font_get_glyph_data(u8g2, e) == ((void*)0) )
 return 0;
    }
  }
  return 1;
...
static u8g2_uint_t u8g2_string_width(u8g2_t *u8g2, const char *str) __attribute__((noinline));
...
# 1502 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_font.c"
u8g2_uint_t u8g2_GetStrWidth(u8g2_t *u8g2, const char *s)
{
  u8g2->u8x8.next_cb = u8x8_ascii_next;
  return u8g2_string_width(u8g2, s);
}
# 1526 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_font.c"
u8g2_uint_t u8g2_GetUTF8Width(u8g2_t *u8g2, const char *str)
{
  u8g2->u8x8.next_cb = u8x8_utf8_next;
