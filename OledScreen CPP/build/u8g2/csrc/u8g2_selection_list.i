# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_selection_list.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_selection_list.c" 2
# 38 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_selection_list.c"
...
# 39 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_selection_list.c" 2
# 52 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_selection_list.c"
void u8g2_DrawUTF8Line(u8g2_t *u8g2, u8g2_uint_t x, u8g2_uint_t y, u8g2_uint_t w, const char *s, uint8_t border_size, uint8_t is_invert)
{
  ...
  fx = x;
  fy = y - ((u8g2)->font_ref_ascent) ;
  fw = w;
  fh = ((u8g2)->font_ref_ascent) - ((u8g2)->font_ref_descent) ;
...
# 128 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_selection_list.c"
u8g2_uint_t u8g2_DrawUTF8Lines(u8g2_t *u8g2, u8g2_uint_t x, u8g2_uint_t y, u8g2_uint_t w, u8g2_uint_t line_height, const char *s)
{
  uint8_t i;
  uint8_t cnt;
...
static u8g2_uint_t u8g2_draw_selection_list_line(u8g2_t *u8g2, u8sl_t *u8sl, u8g2_uint_t y, uint8_t idx, const char *s) __attribute__((noinline));
static u8g2_uint_t u8g2_draw_selection_list_line(u8g2_t *u8g2, u8sl_t *u8sl, u8g2_uint_t y, uint8_t idx, const char *s)
{
  ...
  u8g2_uint_t line_height = ((u8g2)->font_ref_ascent) - ((u8g2)->font_ref_descent)+1;
# 166 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_selection_list.c"
  ...
  if ( s == ((void*)0) )
    s = "";
  u8g2_DrawUTF8Line(u8g2, 1, y, ((u8g2)->width)-2*1, s, border_size, is_invert);
  return line_height;
}
...
# 203 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8g2_selection_list.c"
uint8_t u8g2_UserInterfaceSelectionList(u8g2_t *u8g2, const char *title, uint8_t start_pos, const char *sl)
{
  u8sl_t u8sl;
  u8g2_uint_t yy;
  ...
  if ( title_lines > 0 )
  {
 display_lines = (((u8g2)->height)-3) / line_height;
 u8sl.visible = display_lines;
 u8sl.visible -= title_lines;
  }
  else
  {
 display_lines = ((u8g2)->height) / line_height;
 u8sl.visible = display_lines;
  }
  ...
  for(;;)
  {
      ...
      do
      {
        yy = ((u8g2)->font_ref_ascent);
        if ( title_lines > 0 )
        {
          yy += u8g2_DrawUTF8Lines(u8g2, 0, yy, ((u8g2)->width), line_height, title);

   u8g2_DrawHLine(u8g2, 0, yy-line_height- ((u8g2)->font_ref_descent) + 1, ((u8g2)->width));
   ...
   yy += 3;
      ...
      for(;;)
      {
        event = u8x8_GetMenuEvent(((u8x8_t *)(u8g2)));
        if ( event == (64+(16)) )
          return u8sl.current_pos+1;
        else if ( event == (64+(19)) )
          return 0;
        else if ( event == (64+(17)) || event == (64+(21)) )
        {
          u8sl_Next(&u8sl);
          break;
        }
        else if ( event == (64+(18)) || event == (64+(20)) )
        {
          u8sl_Prev(&u8sl);
          break;
        }
