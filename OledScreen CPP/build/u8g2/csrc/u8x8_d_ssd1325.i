# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1325.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1325.c" 2
# 43 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1325.c"
...
# 44 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1325.c" 2
...
# 83 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1325.c"
static uint8_t u8x8_ssd1325_8to32_dest_buf[32];

static uint8_t *u8x8_ssd1325_8to32(__attribute__((unused)) u8x8_t *u8x8, uint8_t *ptr)
{
  uint8_t v;
  uint8_t a,b;
  uint8_t i, j;
...
static uint8_t u8x8_d_ssd1325_128x64_generic(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
# 136 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1325.c"
    case 11:
      if ( arg_int == 0 )
 ...
 u8x8_cad_SendSequence(u8x8, u8x8_d_ssd1325_128x64_nhd_powersave1_seq);
      break;
# 158 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ssd1325.c"
    case 14:
