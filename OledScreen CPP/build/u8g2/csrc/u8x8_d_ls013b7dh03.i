# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ls013b7dh03.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ls013b7dh03.c" 2
# 39 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ls013b7dh03.c"
...
# 40 "/root/Bela/projects/Pantalla_-_O2O/u8g2/csrc/u8x8_d_ls013b7dh03.c" 2
...
uint8_t u8x8_d_ls013b7dh03_128x128(u8x8_t *u8x8, uint8_t msg, __attribute__((unused)) uint8_t arg_int, void *arg_ptr)
{
  uint8_t y, c, i;
  uint8_t *ptr;
  switch(msg)
  {
    ...
    case 10:
      ...
      u8x8_cad_SendCmd(u8x8, (((((0x04)) & 0x80) >> 7) | ((((0x04)) & 0x40) >> 5) | ((((0x04)) & 0x20) >> 3) | ((((0x04)) & 0x10) >> 1) | ((((0x04)) & 0x08) << 1) | ((((0x04)) & 0x04) << 3) | ((((0x04)) & 0x02) << 5) | ((((0x04)) & 0x01) << 7)) );
    ...
    case 15:
      ...
      u8x8_cad_StartTransfer(u8x8);
      u8x8_cad_SendCmd(u8x8, (((((0x01)) & 0x80) >> 7) | ((((0x01)) & 0x40) >> 5) | ((((0x01)) & 0x20) >> 3) | ((((0x01)) & 0x10) >> 1) | ((((0x01)) & 0x08) << 1) | ((((0x01)) & 0x04) << 3) | ((((0x01)) & 0x02) << 5) | ((((0x01)) & 0x01) << 7)) );


      for( i = 0; i < 8; i++ )
      {
        u8x8_cad_SendCmd(u8x8, ((((y + i) & 0x80) >> 7) | (((y + i) & 0x40) >> 5) | (((y + i) & 0x20) >> 3) | (((y + i) & 0x10) >> 1) | (((y + i) & 0x08) << 1) | (((y + i) & 0x04) << 3) | (((y + i) & 0x02) << 5) | (((y + i) & 0x01) << 7)) );
...
uint8_t u8x8_d_ls027b7dh01_400x240(u8x8_t *u8x8, uint8_t msg, __attribute__((unused)) uint8_t arg_int, void *arg_ptr)
{
  switch(msg)
  {
    case 9:
...
uint8_t u8x8_d_ls027b7dh01_m0_400x240(u8x8_t *u8x8, uint8_t msg, __attribute__((unused)) uint8_t arg_int, void *arg_ptr)
{
  switch(msg)
  {
    case 9:
...
uint8_t u8x8_d_ls013b7dh05_144x168(u8x8_t *u8x8, uint8_t msg, __attribute__((unused)) uint8_t arg_int, void *arg_ptr)
{
  switch(msg)
  {
    case 9:
